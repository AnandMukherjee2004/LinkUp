...
function SignIn() {
  ...
  return (
    <div className=" bg-purple-100 h-screen py-7">
      <div className="mx-2 px-5 mt-5">
        <div className="logo flex logo justify-center">
          <img
            src="logo.jpg"
            alt=""
            className="h-20 w-20"
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-2xl font-semibold text-purple-600 text-center mt-2">
            ...
            <p className="text-base text-[#95a1c8] font-semibold text-center mt-1">
              Stay updated on your professional journey!
            </p>
          </h2>
          ...
          >
            <div className="flex flex-col gap-2">
              <label
                htmlFor="email"
                className="input input-bordered flex items-center gap-2  bg-white text-purple-600"
              >
                <svg
            ...
            <Link to={"/signup"}>
              <p className="text-center font-semibold text-gray-400">
                New to LinkUp, <span className="text-purple-500">Join Now</span>
              </p>
            </Link>
          </form>
        </div>
